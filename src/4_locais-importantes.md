# <a name="_heading=h.4kkwu7r1lm90"></a>Locais importantes
...
A Sala precisa é um espaço que serve como área de estudo e descanso para os alunos da FCT. É um ambiente onde os alunos podem passar o tempo livre entre as aulas para relaxar ou se concentrar em suas atividades acadêmicas. Fica localizada no terceiro andar do novo prédio da FCT (Carinhosamente chamado de "Prédio de Telecom". Leia a próxima seção abaixo para saber mais sobre este local). Ademais, na frente do prédio, olhe para cima e note se a plaquinha de "ABERTO" está posta na janela do terceiro andar.
